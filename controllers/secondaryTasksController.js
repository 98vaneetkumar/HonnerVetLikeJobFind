...
// let downloadResume = require("../controllers/user/userDownloadResumeController");
AWS.config.update({
...
module.exports = {
	htmlToPdf : async(payload) => {
		console.log("payload------htmlToPdf", payload);
		...
		// await Services.UserService.updateData({id:payload.userId}, { downloadUrl: fileNamePdf});
		let createPdf  = await generatePdf(downloadSample);
		...
		console.log(uploadS3.Location, "uploadS3.Location");
		await Services.UserService.updateData({id:payload.userId}, { downloadUrl: uploadS3.Location});
		return {url : uploadS3.Location};
		
	}
};

var generatePdf = (downloadSample) => {
	return new Promise((resolve, reject) => {
		console.log("case1");
		let options = { format: "A4",  timeout: 2400000 };
