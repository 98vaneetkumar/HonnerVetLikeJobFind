exports.forgotPasswordRecruiter = `
<!DOCTYPE html>
    ...
    <table style='vertical-align:top; font-family:Arial, Helvetica, sans-serif; color:#3a3a3a;font-size:14px; background: #EFF2FD; ' width='100%' height='100%' border='0' cellspacing='20' cellpadding='0'>
        <tr>
            <td>
                ...
                <tr>
                <td style='margin:0px;padding:55px 0px 20px; text-align:center;height:50px; width:100%; box-sizing:border-box; '> <img src="{{s3logo}}" width="auto;" style="border-radius:10px;"> </td>
            </tr>
                    <tr>
                        <td style=''>
                            <table cellspacing='0' cellpadding='0' style='padding:20px 20px; width:100%; box-sizing:border-box;'>
                                ...
                                <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 40px 30px; color: #666666; font-family: Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px; text-align: center;" >
                                  <p style="margin: 0;">We've received a request to reset the password for your account.Check below to reset your password</p>
                                </td>
                                </tr>
                                <tr>
                                <tr>
                    ...
                    <tr>
                        <td style='padding:20px 0px 70px;width:100%;box-sizing:border-box; text-align:center; '> <a href='#' style='display:inline-block; color:#333; margin:0px 2px 5px; font-size:12px; text-decoration:underline'>Privacy Policy</a> <a href='#' style='display:inline-block; color:#333; margin:0px 2px 5px; font-size:12px; text-decoration:underline;'>Terms &amp; Conditions </a>
