...
exports.saveData = async (objToSave) => {
	return await baseService.saveData(Models.Hires, objToSave);
};
exports.updateData = async (criteria, objToSave,) => {
	return await baseService.updateData(Models.Hires, criteria, objToSave);
};
...
exports.count = async (criteria) => {
	...
	where.isDeleted = 0;
	where.isBlocked = 0;
	return await baseService.count(Models.Hires, where);
};

exports.getOne = async (criteria) => {
	return await baseService.getSingleRecord(Models.Hires, criteria);
};
