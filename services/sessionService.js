...
exports.getSessionListRecruiter = (criteria, projection, limit, offset) => {
	return new Promise((resolve, reject) => {
		let order = "";
		order = [[Sequelize.literal("id Desc")]];
...
exports.getSessionListSubAdmin = (c,projection, limit, offset) => {
	return new Promise((resolve, reject) => {
		let order = "";
		order = [[Sequelize.literal("id Desc")]];
...
exports.getSessionListAll = (projection, limit, offset) => {
	return new Promise((resolve, reject) => {
		let order = "";
		order = [[Sequelize.literal("id Desc")]];
		Models.Sessions.findAll({
