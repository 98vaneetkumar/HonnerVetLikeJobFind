...
exports.saveData = async (objToSave) => {
	return await baseService.saveData(Models.Specializations, objToSave);
};
exports.updateData = async (criteria, objToSave,) => {
	return await baseService.updateData(Models.Specializations, criteria, objToSave);
};
...
exports.count = async (criteria) => {
	...
	where.isDeleted = 0;
	where.isBlocked = 0;
	return await baseService.count(Models.Specializations, where);
};

exports.getOne = async (criteria) => {
	return await baseService.getSingleRecord(Models.Specializations, criteria);
};
