...
exports.saveData = async (objToSave) => {
	return await baseService.saveData(Models.SuggestSkills, objToSave);
};
exports.updateData = async (criteria, objToSave,) => {
	return await baseService.updateData(Models.SuggestSkills, criteria, objToSave);
};
...
exports.count = async (criteria) => {
	...
	where.isDeleted = 0;
	where.isBlocked = 0;
	return await baseService.count(Models.SuggestSkills, where);
};

exports.getOne = async (criteria) => {
	return await baseService.getSingleRecord(Models.SuggestSkills, criteria);
};
...
exports.saveUserBulkEntriesForSuggestSkills = (arrayToSave) => {
	return new Promise((resolve, reject) => {
		Models.SuggestSkills.bulkCreate(arrayToSave)
			.then((result) => {
				resolve(result);
			})
			.catch((err) => {
